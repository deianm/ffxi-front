                                        ...
                                        <div class="portlet-body">
                                            <div class="table-scrollable">
                                                <table class="table table-striped table-bordered table-advance table-hover">
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <i class="fa fa-briefcase"></i> Item </th>
                                                        <th class="hidden-xs">
                                                            <i class="fa fa-user"></i> Preview </th>
                                                        <th>
                                                    ...
                                                    <tr>
                                                        <td class="highlight">
                                                            <div class="success"></div>
                                                            <a href="javascript:;"> <img title="" src="http://static.ffxiah.com/images/icon/18912.png" class="icon"> Ark Saber </a>
                                                        </td>
                                                        <td class="hidden-xs"> [] </td>
                                                        <td>  $0.50 </td>
                                                        <td>
                                                            <a href="javascript:;" class="btn btn-outline btn-circle btn-sm purple">
                                                                <i class="fa fa-edit"></i> Purchase </a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="highlight">
                                                            <div class="info"> </div>
                                                            <a href="javascript:;"> <img title="" src="http://static.ffxiah.com/images/icon/18563.png" class="icon"> Ark Scythe </a>
                                                        </td>
                                                        <td class="hidden-xs"> [] </td>
                                                        <td> $0.60 </td>
                                                        <td>
