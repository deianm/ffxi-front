...
<head>
    ...
    <meta content="FFXI PS" name="description"/>
    <meta content="" name="deian-m"/>
    ...
    <link href="../css/components-rounded.min.css" rel="stylesheet" id="style_components"
          type="text/css"/>
    <link href="../css/plugins.min.css" rel="stylesheet" type="text/css"/>
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN THEME LAYOUT STYLES -->
    <link href="../css/layout.min.css" rel="stylesheet" type="text/css"/>
    <link href="../css/themes/default.min.css" rel="stylesheet" type="text/css"
          id="style_color"/>
                    ...
                    <div class="container">
                        ...
                        <div class="row" >
                            <div class="col-md-3 col-sm-6 col-xs-12" >
                                <img src="../img/kuppa-logo.png" alt="logo" style="width:183px;">
                            </div>
                            <div class="col-md-9 col-sm-12 col-xs-12">
                                <h1 style="font-size:170px;">FFXI PS</h1>
                            </div>
                        </div>
                        <!-- END LOGO -->
                    </div>
...
<script src="../js/ffxi-ps.min.js" type="text/javascript"></script>
